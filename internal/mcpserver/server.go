...
func toolAnnotations(name string) *mcp.ToolAnnotations {
	closedWorld := false
	if name == "onboard" || name == "rename_symbol" {
		destructive := true
